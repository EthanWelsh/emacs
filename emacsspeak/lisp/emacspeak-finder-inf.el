...
(setq emacspeak-finder-package-info '(
    ...
    ("emacspeak-apt-sources.el"
        ...
        (emacspeak  apt  sources.list))
    ("emacspeak-apt-utils.el"
        "speech-enable APT interface"
    ...
    ("emacspeak-autoload.el"
        ...
        (emacspeak   audio desktop autoload))
    ("emacspeak-babel.el"
    ...
    ("emacspeak-eshell.el"
        ...
        (emacspeak  audio desktop))
    ("emacspeak-ess.el"
        "Speech-enable ESS: Emacs Speaks Statistics "
        (emacspeak   audio desktop statistics  r))
    ("emacspeak-etable.el"
        "Speech enable table.el"
        (emacspeak  audio interface to emacs tables))
    ("emacspeak-eterm.el"
